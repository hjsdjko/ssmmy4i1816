	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="病情" prop="bingqing">
					<el-input v-model="ruleForm.bingqing" placeholder="病情" clearable  :readonly="ro.bingqing"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="病情" prop="bingqing">
					<el-input v-model="ruleForm.bingqing" placeholder="病情" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.bingliwenjian" label="病历文件" prop="bingliwenjian">
					<file-upload
						tip="点击上传病历文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.bingliwenjian" label="病历文件" prop="bingliwenjian">
					<el-button :style='{"cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","borderColor":"#ccc","color":"#999","borderRadius":"0px","background":"none","borderWidth":"1px","width":"auto","lineHeight":"36px","fontSize":"14px","borderStyle":"solid","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.bingliwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else-if="!ruleForm.bingliwenjian" label="病历文件" prop="bingliwenjian">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="诊断结果" prop="zhenduanjieguo">
					<el-input
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.zhenduanjieguo" label="诊断结果" prop="zhenduanjieguo">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhenduanjieguo}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				bingliwenjian: [
					{ required: true, message: '病历文件不能为空', trigger: 'blur' },
				],
				shangchuanshijian: [
				],
			}
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='bingqing'){
							this.ruleForm.bingqing = obj[o];
							this.ro.bingqing = true;
							continue;
						}
						if(o=='zhenduanjieguo'){
