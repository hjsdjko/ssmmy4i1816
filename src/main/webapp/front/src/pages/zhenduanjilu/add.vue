...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="病情" prop="bingqing">
            <el-input v-model="ruleForm.bingqing" 
                placeholder="病情" clearable :disabled=" false  ||ro.bingqing"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="病历文件" prop="bingliwenjian">
            <file-upload
            tip="点击上传病历文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="上传时间" prop="shangchuanshijian">
              <el-date-picker
  ...
  export default {
    ...
    // 多级联动参数
      ...
      bingliwenjianUploadChange(fileUrls) {
          this.ruleForm.bingliwenjian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
    }
  };
</script>
